...
def process_df_img(df, img_size = (32, 128)):
...
def get_dataframe_with_preprocessed_imgs(nb_rows = 1000, img_size = (32, 128), load_pickle_if_exists = True, debug=True, pickle_name="letter_detection_data"):
    ...
    preprocessed_imgs = process_df_img(df, img_size)
    data = {
        'df': df,
